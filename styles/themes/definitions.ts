...
export const themes = {
  ...
  neighbor: {
    ...
    variables: {
      ...
      "--foreground": palette.navy[900],
      "--card-bg": palette.common.white,

      "--card-border": palette.navy[600],
      "--surface-accent": palette.slate[100],
      "--primary": palette.navy[600],
      "--primary-hover": palette.navy[700],
      "--primary-foreground": palette.common.white,
      "--shadow-primary": palette.navy[800],
