  ...
  render: () => {
    ...
    return (
      <Form onSubmit={(e) => e.preventDefault()}>
        <Field label="Email Address" htmlFor="email" description="We'll never share your email.">
          <Input 
            id="email" 
            type="email" 
  ...
  render: () => {
    ...
    return (
      <Form onSubmit={handleSubmit} style={{ maxWidth: '600px' }}>
        ...
        <Field label="Email" htmlFor="email" description="Your primary contact email" required>
          <Input 
            id="email" 
            type="email"
    ...
    return (
      <Form style={{ maxWidth: '800px' }}>
        ...
        <Field label="Email" htmlFor="email-custom">
          <Input id="email-custom" type="email" placeholder="john.doe@example.com" />
        </Field>

        <Field label="Bio" htmlFor="bio-custom">
          <Textarea id="bio-custom" placeholder="Tell us about yourself..." rows={4} />
