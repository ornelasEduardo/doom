...
describe('Layout Components', () => {
  describe('Flex', () => {
    it('renders children correctly', () => {
      render(<Flex><div>Flex Child</div></Flex>);
      expect(screen.getByText('Flex Child')).toBeInTheDocument();
    });

    it('renders as a custom element (polymorphism)', () => {
      render(<Flex as="section" data-testid="flex-section">Content</Flex>);
  ...
  describe('Grid', () => {
    it('renders children correctly', () => {
      render(<Grid><div>Grid Child</div></Grid>);
      expect(screen.getByText('Grid Child')).toBeInTheDocument();
    });

    it('applies grid styles', () => {
      render(
        <Grid columns={3} gap="2rem" data-testid="grid-styled">
          Grid Item
        </Grid>
      );
  ...
  describe('Stack', () => {
    ...
    it('allows overriding direction', () => {
      render(<Stack direction="row" data-testid="stack-row">Row Stack</Stack>);
  ...
  describe('Container', () => {
    ...
    it('supports polymorphism', () => {
      render(<Container as="article" data-testid="container-article">Article Container</Container>);
